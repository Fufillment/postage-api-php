...
class RatesApi extends ApiRequestBase {
	 ...
	 * @return \Fulfillment\Postage\Models\Response\PriceGroup[]|mixed
	 */
	public function getRatesAsPostage($shipperSymbol, $serviceSymbol, $sourceIso2, $destinationIso2, $weight, $zoneName = null, $fromPostalCode = null, $toPostalCode = null, $weightTypeId = 1)
	{
		$queryString = [
